...
-- -----------------------------------------------------
-- Table `ventas_jugos`.`clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`clientes` (
...
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_producto` (
  ...
  `TAMAÑO` VARCHAR(50) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_items_facturas` (
  ...
  CONSTRAINT `FK_FACTURAS`
    FOREIGN KEY (`NUMERO`)
    REFERENCES `ventas_jugos`.`facturas` (`NUMERO`),
